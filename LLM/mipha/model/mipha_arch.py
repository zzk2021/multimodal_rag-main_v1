...
from LLM.mipha.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, \
...
class MiphaMetaForCausalLM(ABC):
    ...
    def encode_images_get_vision_tower(self, image_features):
        image_features = self.get_model().mm_projector(image_features)
        return image_features
