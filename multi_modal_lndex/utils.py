...
def resolve_embed_model(
    ...
    # for image multi-modal embeddings
        ...
        try:
            from clip_base import ClipEmbedding  # pants: no-infer-dep
    ...
    elif isinstance(embed_model, str) and embed_model.startswith("siglip"):
        try:
            from .siglip_base import SiglipEmbedding  # pants: no-infer-dep
            embed_model = SiglipEmbedding()
        except ImportError as e:
            raise ImportError(
                "`siglip_base` not found, "
